        ...
        <div className="mt-8 bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  <span className="px-2 bg-white text-sm text-gray-500">Hoặc đăng nhập bằng</span>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                >
                  <img src={icongg} alt="Google icon" className="w-5 h-5 mr-2" />
                  Google
                </button>
              </div>
            </div>
          ...
          <div className="px-8 py-4 bg-gray-50 text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="/dang-ky" className="font-medium text-emerald-600 hover:text-emerald-500">
                Đăng ký ngay
              </a>
            </p>
          </div>
