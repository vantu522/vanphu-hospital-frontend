      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Vui lòng chọn khoa phù hợp với nhu cầu khám bệnh của bạn</p>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-gray-800">Danh sách các khoa</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {departments.map((dept) => (
                ...
                >
                  ...
                  <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-green-100 to-emerald-100 rounded-full -translate-y-12 translate-x-12 transition-all duration-300 ${
